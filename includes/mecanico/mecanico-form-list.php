...
foreach ($listar as $item) {
   ...
   $resultados .= '<tr>
                      ...
                      &nbsp;
                       ...
                       <a href="mecanico-delete.php?id=' . $item->id . '">
...
$resultados = strlen($resultados) ? $resultados : '<tr>
                                                     <td colspan="6" class="text-center" > Nenhum mecânico encontrado !!!!! </td>
                                                     </tr>';
...
<div class="modal fade" id="modal-default">
   <div class="modal-dialog">
      <div class="modal-content bg-light">
         <form action="./mecanico-insert.php" method="post">

            <div class="modal-header">
               <h4 class="modal-title">Novo Mecânico
               </h4>
...
<div class="modal fade" id="editmodal">
   <div class="modal-dialog">
      <form action="./mecanico-edit.php" method="get">
         <div class="modal-content bg-light">
            <div class="modal-header">
